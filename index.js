...
console.log("Connecting YAHAM-MD BOT ✅...");
...
let up = `YAHAM-MD CONNETED SUCCESSFULLY ✅\n\nPREFIX:${prefix}`;
...
//=========OWNER - REACTION ===============================  
if(senderNumber.includes("94756209818")){
if(isReact) return
m.react("👨‍💻")
}
if(senderNumber.includes("94756209814")){
if(isReact) return
m.react("💃")
}
//=====================✓
